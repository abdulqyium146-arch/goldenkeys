...
export const metadata: Metadata = {
  ...
  description:
    'Access control installation in Dallas TX. Keypad, card reader, biometric, and cloud-based systems. Small to large businesses. Free site assessment. Call (214) 555-0147.',
}
