...
export const metadata: Metadata = {
  ...
  description: 'Professional master key system design and installation in Dallas TX. Offices, apartment complexes, HOAs, schools, and commercial properties. Licensed locksmith. Call (833) 632-3357.',
