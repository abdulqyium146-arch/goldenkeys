...
export const metadata: Metadata = {
  ...
  description:
    'Lost car key replacement in Dallas TX. Transponder keys, push-to-start fobs, laser-cut keys. On-site programming. 40–60% cheaper than dealer. Call (833) 632-3357.',
}
