...
export const metadata: Metadata = {
  ...
  description: 'Trusted locksmith serving Sachse TX. Emergency lockouts, rekeying, car keys, smart locks & commercial security. Licensed & insured. Call (214) 555-0147.',
  alternates: { canonical: `${SITE_URL}/locksmith-sachse-tx/` },
  openGraph: {
    title: `Locksmith Sachse TX | ${BUSINESS_NAME}`,
    description: 'Licensed 24/7 locksmith in Sachse TX. Fast response, upfront pricing. Call (214) 555-0147.',
