...
export const metadata: Metadata = {
  ...
  description: 'Professional lock installation in Dallas TX. New deadbolts, knob locks, lever handles for homes, apartments, and commercial properties. Licensed & insured. Call (214) 555-0147.',
  alternates: { canonical: `${SITE_URL}/lock-installation/` },
  openGraph: { title: 'Lock Installation Dallas TX | Golden\'s Keys', description: 'Professional lock installation for residential and commercial properties in Dallas TX. Call (214) 555-0147.', url: `${SITE_URL}/lock-installation/` },
}
