...
export const metadata: Metadata = {
  ...
  description: 'Trusted locksmith serving Wylie TX. Emergency lockouts, rekeying, car keys, smart locks & commercial security. Licensed & insured. Call (833) 632-3357.',
  alternates: { canonical: `${SITE_URL}/locksmith-wylie-tx/` },
  openGraph: {
    title: `Locksmith Wylie TX | ${BUSINESS_NAME}`,
    description: 'Licensed 24/7 locksmith in Wylie TX. Fast response, upfront pricing. Call (833) 632-3357.',
